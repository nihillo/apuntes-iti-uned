...
## 2.9 Retirada
- Exclusiva d einstrucciones de almacenamiento
...
- Cuando haexiste dependencia RAW
- Condición Comporbear direcciones coincidentes de carga y almacenamiento pendiente
...
- Técnicas
	- Ignorar
	- Permitir interrupciones algo imprecisas pero de forma que se pueda recrear una secuenccia precisa
