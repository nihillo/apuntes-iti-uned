...
- Correspondencia clave directa - clave en subconjunto de tabla hash -> función hash
	- Colisión -> dos diferente claves directas se traducen a una misma clave hash
...
- Factor de carga
	...
	- La probabilidad de colisiónal insertar una clave es $\delta$
...
- Estrategias para la resolución de las colisiones
	...
	- Hashing cerrado (o direccionamiento abierto)
		- Búsqueda en direcciones alternativas de la tabla
		- Métodos:
			- Recorrido lineal
