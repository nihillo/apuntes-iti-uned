...
- VANcomo función del tipo de descuento -> VAN(k) (la rentabilidad requerida k no es ahora un valor sino una variable)
- Para inversiones simples y analizables, el VAN decrece según una curva, hasta que en un punto pasa a ser negativo
	...
	- Cuando k tiende a infinito -> VAN tiende a -A
